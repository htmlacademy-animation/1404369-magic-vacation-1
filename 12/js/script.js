...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return AnimateFrame; });
class AnimateFrame {
...
/***/ "./source/js/modules/animateText.js":
/*!******************************************!*\
  !*** ./source/js/modules/animateText.js ***!
  \******************************************/
/*! exports provided: default */
...
/***/ "./source/js/modules/animateTitle.js":
/*!*******************************************!*\
  !*** ./source/js/modules/animateTitle.js ***!
  \*******************************************/
/*! exports provided: default */
...
/*!****************************************!*\
  !*** ./source/js/modules/constants.js ***!
  \****************************************/
/*! exports provided: GAME_TIMER_DURATION, PRIZES_SETTING_VALUE */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GAME_TIMER_DURATION", function() { return GAME_TIMER_DURATION; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PRIZES_SETTING_VALUE", function() { return PRIZES_SETTING_VALUE; });
// game timer 5 min transfer in ms
const GAME_TIMER_DURATION = 300000;

const PRIZES_SETTING_VALUE = [
  {
    currentValue: 1,
    finalValue: 3,
    duration: 2800
...
/* harmony import */ var _prizes__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./prizes */ "./source/js/modules/prizes.js");
...
class FullPageScroll {
  ...
  changeVisibilityDisplay() {
    ...
    if (this.screenElements[this.activeScreen].classList.contains(`screen--prizes`)) {
      this.setPrizesIcon();
      _prizes__WEBPACK_IMPORTED_MODULE_2__["default"].startAnimatePrizesValues();
    } else {
      _prizes__WEBPACK_IMPORTED_MODULE_2__["default"].stopAnimatePrizesValues();
    }

    if (this.screenElements[this.activeScreen].classList.contains(`screen--game`)) {
      setTimeout(() => {
        _timer__WEBPACK_IMPORTED_MODULE_1__["default"].startAnimateTimer();
      }, 1000);
    } else {
      _timer__WEBPACK_IMPORTED_MODULE_1__["default"].stopAnimateTimer();
    }
  }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _animateFrame__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./animateFrame */ "./source/js/modules/animateFrame.js");
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./constants */ "./source/js/modules/constants.js");
...
class AnimatePrizesValue {
  ...
  init() {
    this.prizesValues = _constants__WEBPACK_IMPORTED_MODULE_1__["PRIZES_SETTING_VALUE"];
    this.prizesValuesNode = document.querySelectorAll(`.prizes__value`);
    this.prizesValuesNode.forEach(() => {
      let frame = new _animateFrame__WEBPACK_IMPORTED_MODULE_0__["default"](this.animateValue, 1000 / 12, 0);
  ...
  startAnimatePrizesValues() {
    this.frames.forEach((frame, index) => {
      ...
      }, _constants__WEBPACK_IMPORTED_MODULE_1__["PRIZES_SETTING_VALUE"][index].duration);
    });
  }
...
/* harmony default export */ __webpack_exports__["default"] = (animatePrizesValue);
...
class Timer {
  ...
  init() {
    ...
    this.animateFrame = new _animateFrame__WEBPACK_IMPORTED_MODULE_0__["default"](this.getTimerValue, 1000 / 24, this.duration);
  }
...
const timer = new Timer(_constants__WEBPACK_IMPORTED_MODULE_1__["GAME_TIMER_DURATION"]);
...
/* harmony import */ var _modules_animateText__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/animateText */ "./source/js/modules/animateText.js");
/* harmony import */ var _modules_animateTitle__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/animateTitle */ "./source/js/modules/animateTitle.js");
...
Object(_modules_animateTitle__WEBPACK_IMPORTED_MODULE_10__["default"])();

const fullPageScroll = new _modules_full_page_scroll__WEBPACK_IMPORTED_MODULE_8__["default"]();
fullPageScroll.init();
_modules_prizes__WEBPACK_IMPORTED_MODULE_12__["default"].init();
...
animationTexts.forEach(({selector, duration, delay}) => {
  Object(_modules_animateText__WEBPACK_IMPORTED_MODULE_9__["default"])(selector, duration, delay);
});
